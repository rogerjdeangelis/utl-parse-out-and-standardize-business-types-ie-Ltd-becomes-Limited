...
basic_cleanup, meta = pyreadstat.read_sas7bdat('d:/sd1/have.sas7bdat', catalog_file='d:/fmt/formats.sas7bcat', formats_as_category=True);
dict(sorted(basic_cleanup.values.tolist()));                                                                                             
basic_cleanup_tests=OrderedDict(basic_cleanup.values.tolist());                                                                          
stor=pd.DataFrame();                                                                                                                     
for key, value in basic_cleanup_tests.items():;                                                                                          
.     tmps = cleanco(value);                                                                                                             
...
print(stor);                                                                                                                             
pyreadstat.write_xport(stor,'d:/xpt/stor.xpt',table_name='stor');                                                                        
");                                                                                                                                      
...
data want;                                                                                                                               
  set xpt.stor;                                                                                                                          
  company=scan(business,1,'[');                                                                                                          
  Type_of_Business=scan(business,2,"'");                                                                                                 
  drop Business;                                                                                                                         
run;quit;                                                                                                                                
